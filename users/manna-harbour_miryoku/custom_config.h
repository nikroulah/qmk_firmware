...
// manna-harbour_miryoku.c; everything else stays at TAPPING_TERM (200).
...
// makes the config.h MOUSEKEY_DELAY/INTERVAL/MAX_SPEED/TIME_TO_MAX inert).
...
// are defined in miryoku_babel/miryoku_layer_alternatives.h (see the header
// comments there). The skeletyl (split_3x5_3) is the default; the sweep
// (split_3x5_2) is a separate, simpler layout selected by keyboard.
// Neither board uses the EXTRA/TAP slots anymore (num/sym are on Q/W
// letter-holds), so both point at a blank layer.
