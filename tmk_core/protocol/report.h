...
// nikroulah forward-port from zsa/qmk_firmware (firmware25): Precision Touchpad
// multitouch report structures. Gated by DIGITIZER_MODE_TOUCHPAD so non-touchpad
// builds (incl. the AVR skeletyl/sweep) are unaffected.
